...
export const translations: Translations = {
  [Language.ES]: {
    ...
    // Home Page
    bienvenidaPrincipal: "¡Bienvenidos! Haz clic en cada día para ver información de la ciudad, mapas y recomendaciones.",
    ...
    ai_translate_chat: "Traducir Chat",
    ai_chat_input_placeholder: "Escribe tu pregunta aquí...",
    ai_chat_send_button: "Enviar mensaje",
    // Currency Converter
    ...
    day: "Día",
    day1_title: "Llegada y Palermo",
    day1_desc: "Bienvenida a Buenos Aires. Traslado al hotel y un primer paseo relajado por los bosques y lagos de Palermo.",
    day2_title: "Historia y Cultura",
    day2_desc: "Explora el corazón histórico de la ciudad: Plaza de Mayo, la Casa Rosada y el Cabildo.",
    day3_title: "Arte y Tango en La Boca",
    day3_desc: "Visita al colorido Caminito, el estadio de Boca Juniors y una cena con espectáculo de tango.",
    day4_title: "Viaje y llegada a Rosario",
    day4_desc: "Mañana de viaje en bus hacia Rosario. Tarde libre para instalarse y descubrir los alrededores del hotel.",
    day5_title: "Monumento y Costanera",
    day5_desc: "Visita al imponente Monumento a la Bandera y un paseo por la costanera del río Paraná.",
    ...
    malargue_ai_prompt_menu: "Eres un experto en gastronomía cuyana y nutrición. Genera un plan de menú de un día (desayuno, almuerzo, cena) para una familia que visita Malargüe, Argentina. Las opciones deben ser aptas para diabéticos, bajas en carbohidratos y, si es posible, sin gluten, destacando el chivito local adaptado. Considera estas preferencias adicionales del usuario: ",
    ...
    malargue_ai_prompt_accommodation: "Eres un asistente de viajes experto. Genera 3-5 sugerencias de alojamiento en Malargüe, Argentina, ideales para una familia con 2 hijos. Considera opciones seguras y adecuadas para familias que buscan aventura. Incluye diferentes tipos (hoteles, cabañas). Ten en cuenta esta información adicional del usuario: ",
    ...
    malargue_ai_prompt_family_tips: "Eres un guía turístico experto para familias. Proporciona 5 consejos prácticos y personalizados para una familia con niños que visita Malargüe, Argentina. Cubre actividades de aventura (con precauciones), ciencia y logística. Considera esta información adicional del usuario: ",
    ...
    malargue_ai_prompt_budget_analysis: "Eres un asesor financiero de viajes. Analiza el presupuesto orientativo para una familia en Malargüe, Argentina. Consulta el presupuesto detallado de la ciudad y proporciona un desglose estimado por día y categoría, y sugiere 2-3 formas de optimizar este presupuesto. Considera estas notas del usuario: ",
    ...
    // Family Budget Manager Section
    gestion_presupuesto_familiar_titulo: "Gestión del presupuesto familiar",
    budget_manager_table_concept: "Concepto",
    budget_manager_table_details: "Detalles",
    budget_manager_table_dates: "Fechas",
    budget_manager_table_estimated_cost: "Costo Estimado",
    budget_manager_table_actual_cost: "Costo Real",
    budget_manager_table_notes: "Notas",
    budget_manager_table_empty: "Click para agregar notas...",
    budget_manager_table_enter_cost: "Ingresar costo...",
    budget_manager_table_generating: "Generando presupuesto inicial...",

    // Family Photo Album
    family_photo_album_title: "Álbum de Fotos Familiar",
    family_photo_album_notice: "Nota: Las fotos se guardan en este dispositivo y no se comparten en la nube.",
    family_photo_album_upload_btn: "Subir Fotos",
    family_photo_album_modal_title: "Subir nuevas fotos",
    family_photo_album_modal_city_label: "Ciudad",
    family_photo_album_modal_day_label: "Día del Itinerario",
    family_photo_album_modal_date_label: "Fecha de la Foto",
    family_photo_album_modal_day_placeholder: "Ej: 3",
    family_photo_album_modal_files_label: "Seleccionar imágenes",
    family_photo_album_modal_uploading: "Subiendo...",
    family_photo_album_modal_cancel: "Cancelar",
    family_photo_album_empty: "Aún no hay fotos. ¡Sube el primer recuerdo!",
    family_photo_album_delete_confirm: "¿Estás seguro de que quieres eliminar esta foto?",
    family_photo_album_photos_in: "Fotos en {cityName}",
    family_photo_album_day_prefix: "Día {day}",
  ...
  [Language.HE]: {
    ...
    // Home Page
    bienvenidaPrincipal: "ברוכים הבאים! לחצו על כל יום לצפייה במידע על העיר, מפות והמלצות.",
    ...
    // AI Chat Box (General)
    ai_new_chat: "צ'אט חדש",
    ai_translate_chat: "תרגם צ'אט",
    ai_chat_input_placeholder: "כתוב את שאלתך כאן...",
    ai_chat_send_button: "שלח הודעה",
    // Currency Converter
    ...
    // Itinerary Day by Day
    day: "יום",
    day1_title: "הגעה ושכונת פאלרמו",
    day1_desc: "ברוכים הבאים לבואנוס איירס. העברה למלון וטיול רגוע ראשון ביערות ובאגמים של פאלרמו.",
    day2_title: "היסטוריה ותרבות",
    day2_desc: "גלו את הלב ההיסטורי של העיר: פלאסה דה מאיו, הקאסה רוסדה והקבילדו.",
    day3_title: "אמנות וטנגו בלה בוקה",
    day3_desc: "ביקור ברחוב קמיניטו הצבעוני, אצטדיון בוקה ג'וניורס וארוחת ערב עם מופע טנגו.",
    day4_title: "נסיעה והגעה לרוסאריו",
    day4_desc: "נסיעת בוקר באוטובוס לרוסאריו. אחר צהריים חופשי להתארגנות וגילוי סביבת המלון.",
    day5_title: "אנדרטת הדגל והטיילת",
    day5_desc: "ביקור באנדרטת הדגל המרשימה וטיול לאורך הטיילת על גדת נהר פרנה.",
...
<<<<<<< HEAD
    ...
    mendoza_dates_duration: "- **שהייה**: 06/10 עד 10/10 (5 ימים)\n- **הערה**: כולל טיול למלארגואה.\n- **איך מגיעים**: טיסה מברילוצ'ה (BRC).",
    jujuy_dates_duration: "- **שהייה**: 11/10 עד 14/10 (4 ימים)\n- **איך מגיעים**: טיסה ממנדוסה (MDZ).",
    iguazu_dates_duration: "- **שהייה**: 15/10 עד 17/10 (3 ימים)\n- **איך מגיעים**: טיסה מחוחוי (JUJ).",
...
>>>>>>> 4a2e980590cb35e55bb7347c839da3e448a7da5c
    ...
    malargue_ai_prompt_menu: "אתה מומחה לגסטרונומיה קוז'אנה ותזונה. צור תוכנית תפריט יומית (ארוחת בוקר, צהריים, ערב) למשפחה המבקרת במלארגואה, ארגנטינה. האפשרויות צריכות להיות מתאימות לסוכרתיים, דלות פחמימות, ואם אפשר, ללא גלוטן, תוך הדגשת הצ'יביטו המקומי המותאם. התחשב בהעדפות נוספות אלה של המשתמש: ",
    ...
    _ai_prompt_general: "אתה עוזר נסיעות מומחה בארגנטינה. ענה על שאלות כלליות לגבי טיול משפחתי של 30 יום בארגנטינה.",
    ...
    malargue_ai_prompt_accommodation: "אתה סוכן נסיעות מומחה. צור 3-5 הצעות לינה במלארגואה, ארגנטינה, אידיאליות למשפחה עם 2 ילדים. קח בחשבון אפשרויות בטוחות ומתאימות למשפחות המחפשות הרפתקאות. כלול סוגים שונים (בתי מלון, בקתות). קח בחשבון מידע נוסף זה מהמשתמש: ",
    ...
    malargue_ai_prompt_family_tips: "אתה מדריך טיולים מומחה למשפחות. ספק 5 טיפים מעשיים ומותאמים אישית למשפחה עם ילדים המבקרת במלארגואה, ארגנטינה. כסה פעילויות הרפתקניות (עם אמצעי זהירות), מדע ולוגיסטיקה. קח בחשבון מידע נוסף זה מהמשתמש: ",
    ...
    malargue_ai_prompt_budget_analysis: "אתה יועץ פיננסי לטיולים. נתח את התקציב המשוער למשפחה במלארגואה, ארגנטינה. עיין בתקציב המפורט של העיר וספק פירוט משוער ליום ולקטגוריה, והצע 2-3 דרכים לייעל תקציב זה. קח בחשבון הערות אלה מהמשתמש: ",
    ...
    // Family Budget Manager Section
    gestion_presupuesto_familiar_titulo: "ניהול תקציב משפחתי",
    budget_manager_table_concept: "סעיף",
    budget_manager_table_details: "פרטים",
    budget_manager_table_dates: "תאריכים",
    budget_manager_table_estimated_cost: "עלות משוערת",
    budget_manager_table_actual_cost: "עלות בפועל",
    budget_manager_table_notes: "הערות",
    budget_manager_table_empty: "לחץ להוספת הערות...",
    budget_manager_table_enter_cost: "הזן עלות...",
    budget_manager_table_generating: "יוצר תקציב ראשוני...",

    // Family Photo Album
    family_photo_album_title: "אלבום תמונות משפחתי",
    family_photo_album_notice: "שימו לב: התמונות נשמרות במכשיר זה בלבד ואינן משותפות בענן.",
    family_photo_album_upload_btn: "העלה תמונות",
    family_photo_album_modal_title: "העלאת תמונות חדשות",
    family_photo_album_modal_city_label: "עיר",
    family_photo_album_modal_day_label: "יום במסלול",
    family_photo_album_modal_date_label: "תאריך הצילום",
    family_photo_album_modal_day_placeholder: "למשל: 3",
    family_photo_album_modal_files_label: "בחר תמונות",
    family_photo_album_modal_uploading: "מעלה...",
    family_photo_album_modal_cancel: "ביטול",
    family_photo_album_empty: "עדיין אין תמונות. העלו את הזיכרון הראשון!",
    family_photo_album_delete_confirm: "האם אתה בטוח שברצונך למחוק תמונה זו?",
    family_photo_album_photos_in: "תמונות ב-{cityName}",
    family_photo_album_day_prefix: "יום {day}",
  },
};
