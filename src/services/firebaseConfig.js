...
if (firebaseCredentials && firebaseCredentials.apiKey && firebaseCredentials.apiKey !== "REPLACE_WITH_YOUR_API_KEY") {
  try {
    ...
    console.log("Firebase initialized successfully from firebaseCredentials.js.");
  } catch (error) {
    console.error(`CRITICAL: Firebase initialization failed. Check the configuration object in src/firebaseCredentials.js. Details: ${error.message}`);
  }
} else {
